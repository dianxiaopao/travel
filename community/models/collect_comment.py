...
class CollectComment(models.Model):
    topic = models.ForeignKey('community.Comment', blank=True, null=True, related_name='+', verbose_name='评论名称')
    user = models.ForeignKey('auth.User', blank=True, null=True, related_name='+', verbose_name='关注者')
