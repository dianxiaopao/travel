...
class GuideTitle(models.Model):
    ...
    title_img = models.ForeignKey(u'mycenter.ImgMaterial', related_name='+', verbose_name=u'文章标题图的id', null=True)
    title_ico = models.ForeignKey(u'mycenter.ImgMaterial', related_name='+', verbose_name=u'文章标题图的id', null=True)
